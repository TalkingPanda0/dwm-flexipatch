...
static char normfgcolor[]                = "#d3dae3";
static char normbgcolor[]                = "#222222";
static char normbordercolor[]            = "#444444";
static char normfloatcolor[]             = "#db8fd9";
static char selfgcolor[]                 = "#4877b1";
static char selbgcolor[]                 = "#222222";
static char selbordercolor[]             = "#2f433f";
...
static char titleselfgcolor[]            = "#4877b1";
...
static const Rule rules[] = {
	...
	RULE(.class = "Gimp", .tags = 1 << 8,.wintype = WTYPE "NORMAL")
	RULE(.class = "portal2_linux", .tags = 1 << 3,.wintype = WTYPE "NORMAL")
	RULE(.class = "LibreWolf", .tags = 1 << 0)
	RULE(.class = "st-256color",.isterminal = 1)
	RULE(.class = "st-256color",.isterminal = 1,.title = "gamelauncher",.tags = 1 << 3)
	RULE(.class = "st-256color",.isterminal = 1,.title = "Cmus",.tags = 1 << 4)
...
static const Layout layouts[] = {
	...
	#if GRIDMODE_LAYOUT
	{ "HHH",      grid }, /* first entry is default */
	#endif
	#if HORIZGRID_LAYOUT
	{ "---",      horizgrid },
	#endif
...
static Key keys[] = {
    ...
    { MODKEY,						XK_z,		spawn,			SHCMD("pactl set-sink-mute @DEFAULT_SINK@ toggle") },
    { MODKEY|ShiftMask,				XK_Up,		spawn,			SHCMD("cmus-remote -v +5%") },
    { MODKEY|ShiftMask,				XK_Down,	spawn,			SHCMD("cmus-remote -v -5%") },
    { MODKEY,						XK_Right,	spawn,			SHCMD("cmus-remote -n") },
    { MODKEY,						XK_Left,	spawn,			SHCMD("cmus-remote -r") },
    { MODKEY,						XK_x,		spawn,			SHCMD("cmus-remote -u") },
    ...
    {MODKEY, XK_v, spawn, SHCMD("passmenu")},
	{MODKEY, XK_b, spawn, SHCMD("librewolf")},
	{MODKEY, XK_F4, spawn, SHCMD("pavucontrol")},
    {MODKEY, XK_g, spawn, SHCMD("st -e gamelauncher")},
    {MODKEY|ShiftMask, XK_c, spawn, SHCMD("st -e calc")},
    {MODKEY | ShiftMask, XK_r, spawn, SHCMD("st -e htop")},
    {MODKEY| ShiftMask, XK_F5, spawn, SHCMD("killall xmouse")},
	...
	{0,XK_Scroll_Lock, spawn, SHCMD("xset s activate ") },
	{0,XK_Pause, spawn, SHCMD("xset s activate | doas pm-suspend") },
